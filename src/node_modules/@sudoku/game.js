...
export function loadFromStorage(diff) {
	difficulty.set(diff);
	cursor.reset();
	return grid.loadFromStorage()
      && userGrid.loadFromStorage()
      && candidates.loadFromStorage()
      && timer.loadFromStorage()
	  && hints.loadFromStorage();
