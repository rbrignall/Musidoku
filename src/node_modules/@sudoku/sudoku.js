...
//import{parseGrid, serializeGrid } from 'sudoku-master'; // Doesn't work
...
export function generateSudoku(difficulty = 'easy') {
    const origpuzzle=getSudoku(difficulty);
    //console.log(origpuzzle);
    
    const sudoku = chunkList(origpuzzle.puzzle.replace(/-/g, '0').split('').map(s => parseInt(s)),9);//getSudoku(difficulty);
    //console.log(sudoku);
